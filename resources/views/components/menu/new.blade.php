<nav x-data="{ mobileMenuIsOpen: false }" @click.away="mobileMenuIsOpen = false" id="navBar"
    ...
    <a href="#" class="text-2xl font-bold gap-4 inline-flex items-center">
        ...
        <span class="hover:scale-110 duration-300 transition-all ease-out">{{ config('aadmin.brand')}}</span>
    </a>
    <!-- Desktop Menu -->
    <ul class="hidden items-center gap-16 md:flex">
        <li class="hover:tracking-wide hover:font-bold hover:text-black hover:underline duration-300 transition-all ease-out"><a href="{{route('home')}}"
        ...
        <li class="hover:tracking-wide hover:font-bold hover:text-black hover:underline duration-300 transition-all ease-out"><a href="{{route('about')}}"
        ...
        <li class="hover:tracking-wider hover:font-bold hover:text-black hover:underline duration-300 transition-all ease-out"><a href="{{route('blog')}}"
               class=" underline-offset-2  focus:outline-none focus:underline dark:text-neutral-300 dark:hover:text-white"
               wire:navigate>Blog</a>
        </li>
        <li class="hover:tracking-wider hover:font-bold hover:text-black hover:underline duration-300 transition-all ease-out"><a href="{{route('service')}}"
               class=" underline-offset-2  focus:outline-none focus:underline dark:text-neutral-300 dark:hover:text-white"
               wire:navigate>Services</a>
        </li>
        <li class="hover:tracking-wider hover:font-bold hover:text-black hover:underline duration-300 transition-all ease-out"><a href="{{route('contact')}}"
               class=" underline-offset-2  focus:outline-none focus:underline dark:text-neutral-300 dark:hover:text-white"
        ...
        @if (Route::has('login'))
            @auth
                ...
                <li class="hover:tracking-wider hover:font-bold hover:text-red-300 drop-shadow-lg hover:underline duration-300 transition-all ease-out"><a href="{{route('logout')}}"
            ...
            @else
                <li class="hover:tracking-wider hover:font-bold hover:text-cyan-300 hover:underline duration-300 transition-all ease-out"><a href="{{route('login')}}"
